#!/usr/bin/env python3
"""Captura baseline de todas las pantallas principales sobre la app real (login demo)."""
...
def run(url):
    with sync_playwright() as p:
        ...
        page.evaluate(SEED)
        for tab, name in [("home","b-home.png"),("budgets","b-budgets.png"),("cuentas","b-cuentas.png"),
                          ("dash","b-dash.png"),("history","b-history.png"),("settings","b-settings.png"),
                          ("notifications","b-notifications.png")]:
