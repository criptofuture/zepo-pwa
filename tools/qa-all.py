...
CHECKS = [
    ...
    ("Candado: la red mala NO degrada el plan a free", ["python", os.path.join(TOOLS, "qa-plan-no-degrada.py")]),
    ...
    ("Candado gesto atras: ninguna pantalla huerfana", ["python", os.path.join(TOOLS, "qa-back-gesture.py")]),
    ...
    ("E2E orden de 'Movimientos recientes' (gasto con fecha vieja no encabeza)", ["python", os.path.join(TOOLS, "qa-e2e-orden-recientes.py")]),
